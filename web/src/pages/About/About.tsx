        ...
        >
          <div className="relative">
            <div className="flex flex-col items-center justify-center">
              <p className="mt-10 mb-5 text-[30px] font-semibold">
                これはしりとりでブロックチェーン上にあなたと世界の誰かを”繋げる"アプリです
              </p>
              <div className="flex w-3/4 items-start justify-center">
                <p className="mt-16 mr-10 text-[10px] leading-8 md:text-[24px]">
          ...
          <div className="relative">
            <div className="flex flex-col items-center justify-center">
              <p className="mt-10 mb-5 text-[30px] font-bold">
                つなげる文字を考えよう！
              </p>
              <div className="flex w-3/4 items-start justify-center">
                <p className="mt-16 mr-10 text-[10px] md:text-[24px]">
                  さっそくアプリを使ってみましょう！
                  <br />
                  <br />
          ...
          <div className="relative">
            <div className="flex flex-col items-center justify-center">
              <p className="mt-10 mb-20 text-[30px] font-bold">
                実際につなげてみよう！
              </p>
              <div className="flex w-3/4 flex-col items-center justify-center">
                <p className="w-3/4 text-[10px] md:text-[24px]">
          ...
          <div className="relative">
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex w-3/4 items-start justify-center">
                <p className="mr-10 text-[10px] md:text-[24px]">
                  しりとりをつなげることができましたか？
                  <br />
                  おめでとうございます！！
                  <br />
